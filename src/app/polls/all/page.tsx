...
interface Poll { slug: string; title: string; prompt: string; description?: string | null; status: 'published' | 'closed'; totalVotes: number; options: PollOption[]; }
