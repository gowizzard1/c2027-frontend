...
interface Poll { slug: string; title: string; race?: string; prompt: string; description?: string | null; disclosure: string; status: 'published' | 'closed'; version: number; publishedAt?: string | null; closedAt?: string | null; totalVotes: number; options: Option[]; }
